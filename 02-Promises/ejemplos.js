...
var primerMetodo = function () {
  var promise = new Promise(function (resolve, reject) {
    setTimeout(function () {
      ...
      reject("a"); //pasamos unos datos para ver como los manejamos
...
var p = Promise.all([p1, p2, p3])
  ...
  .catch(function (err) {
    console.warn(err + "boludazo"); //mostramos el error por consola. Veremos que es el que falló primero, o sea el del primer metodo
  });
